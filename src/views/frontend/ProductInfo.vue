<template>
  <div>
    ...
    <div class="container">
      <div class="row">
        <div
          class="col-md-6 col-12 text-center d-flex justify-content-around mt-5 mb-5"
        >
          <div
            style="
              height: 500px;
        ...
        <div class="col-md-6 col-12 col-lg-4 mt-3">
          ...
          <span class="badge bg-danger text-light mb-1 mr-3"
            >HOT全館消費滿500免運費</span
          >
          <span class="badge bg-danger text-light mb-1"
            >優惠期間來店自取買大送大</span
          >
          ...
          <div v-if="product.id == '-MRxLyObEuJShuo2pU_v'">
            ...
            <p class="mt-1">
              經典夏威夷披薩口味，當甜中帶點微酸的鳳梨，加上魷魚，讓你越吃越順口。
            </p>
          ...
          <div v-if="product.id == '-MRxMLXap74Slfu3T2mz'">
            <h2 class="font-weight-bold mt-2">商品介紹:</h2>
            <p class="mt-1">
              經典的披薩口味。一般說法認為瑪格麗特披薩這個名字是來自於義大利王妃瑪格麗特。由於瑪格麗特王妃對這種披薩十分鍾愛，因此用自己的名字命名。
            </p>
            <h2 class="font-weight-bold mt-2">食材:</h2>
          ...
          <div v-if="product.id == '-MRxMv6BdkYhf2bnnUnm'">
            <h2 class="font-weight-bold mt-2">商品介紹:</h2>
            <p class="mt-1">
              上鮮美的蘑菇與青花菜和紅椒，再加上特製醬汁，喜歡蘑菇的朋友不容錯過
            </p>
            <h2 class="font-weight-bold mt-2">食材:</h2>
          ...
          <div v-if="product.id == '-MRxOUjOiGZ-kf7cgZAF'">
            <h2 class="font-weight-bold mt-2">商品介紹:</h2>
            <p class="mt-1">
              燻雞加上日式和風醬絕對讓你回味無窮，喜愛日式風味的朋友絕不能錯過！
            </p>
            <h2 class="font-weight-bold mt-2">食材:</h2>
          ...
          <div v-if="product.id == '-MRxPZiT44WZvTATpw-I'">
            <h2 class="font-weight-bold mt-2">商品介紹:</h2>
            <p class="mt-1">
              撒上多種蔬果與調味料加上芝麻餅皮酥脆的口感，喜歡蔬食的你絕不能錯過。
            </p>
            <h2 class="font-weight-bold mt-2">食材:</h2>
          ...
          <div v-if="product.id == '-MRxPw6bXfPtIOz6Y3MR'">
            <h2 class="font-weight-bold mt-2">商品介紹:</h2>
            <p class="mt-1">
              濃濃的青醬加上滿滿的新鮮蝦子，讓你感受蝦子與PIZZA在嘴裡跳動的感覺。
            </p>
            <h2 class="font-weight-bold mt-2">食材:</h2>
          ...
          <div class="mt-3">
            ...
            <router-link
              to="/ShoppingCart"
              class="btn btn-success btn-lg float-right float-bottom"
              >前往結帳</router-link
            >
          </div>
        </div>
    ...
    <div class="bg-dark">
      <div class="container">
        <div class="d-flex justify-content-center">
          <h2 class="text-danger font-weight-bold h2 mt-3">您可能也喜歡</h2>
        </div>
      ...
      <div class="container pt-3 pb-3">
        <div>
          <ul>
            ...
            <li class="mt-2">
              2.遇到特定假日外送時間將無法保證30分鐘內到達，請事先打電話詢問謝謝。
            </li>
            <li class="mt-2">
              3.本店所使用的食材全部是經過國際認證的安全食材，請客戶安心使用。
            </li>
            <li class="mt-2">
              4.電子報會不定期釋放特別優惠，快追蹤我們的粉絲團才不會錯過任何優惠消息
            </li>
